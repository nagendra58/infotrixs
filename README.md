_**Build a Weather checking application Description: **_
...
• Ensure proper error handling and data validation. You'll need to use API for getting data from the web 
• Create a proper documentation of commands to use Some Help:
